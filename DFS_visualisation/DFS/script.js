const canvas = document.getElementById('canvas');
    ...
    // Функция для получения узла по координатам
    ...
    function drawArrow(from, to) {
      ...
      // Показываем стрелку, если directed
      if (isDirected) {
        const headlen = 10;
        ctx.beginPath();
        ctx.moveTo(tx, ty);
    ...
    // Функция DFS с сохранением состояния стека
    ...
    // Функции для загрузки различных примеров
    ...
    // Функция для обновления отображения стека
    ...
    // Переключение между направленным и ненаправленным графом
